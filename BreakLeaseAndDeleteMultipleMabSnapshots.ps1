...
Param(
        ...
        [Parameter(Mandatory=$True)][System.Collections.ArrayList] $SnapshotNameList,
...
foreach ($SnapshotName in $SnapshotNameList)
{
    ...
    Param(
        ...
        [Parameter(Mandatory=$True)][System.String] $FileShareName,
        [Parameter(Mandatory=$True)][System.Collections.ArrayList] $SnapshotName
        )
